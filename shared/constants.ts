...
export const WORM_MAX_STEP_UP = 6; // ile pikseli robak może "wejść" pod górę na krok
...
export const RETREAT_TIME = 3; // s po strzale
export const ROUND_END_DELAY = 2.5; // s oczekiwania na uspokojenie fizyki
